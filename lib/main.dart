...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) => SportWidgetBloc(StaticDataRepository(_createNetworkClient(), Config()), Log())..add(LoadIndividualTotal()),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => {context.read<SportWidgetBloc>()..add(LoadIndividualTotal())},
        tooltip: 'Increment',
